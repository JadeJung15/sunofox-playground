...
function renderArcade() {
    ...
    app.innerHTML = `
        <div class="card arcade-container fade-in">
            ...
            <details class="profile-details"><summary>📦 행운의 아이템 뽑기</summary><div class="game-zone" style="background:var(--bg-color); border-radius:12px; padding:1.2rem;"><div id="gacha-result" class="gacha-box" style="height:100px; display:flex; align-items:center; justify-content:center; margin-bottom:1rem; border:2px dashed var(--border-color); border-radius:10px;">준비 완료!</div><button id="gacha-btn" class="btn-primary">100P로 뽑기</button></div></details>
