import { initAuth, updateUI, UserState, addPoints as authAddPoints, authReady } from './auth.js?v=8.3.1';
import { copyLink } from './share.js?v=8.3.1';
import { renderBoard } from './board.js?v=8.3.1';
import { renderRanking } from './ranking.js?v=8.3.1';
...
import { renderHome, renderCategorySelection, fetchAllLikes, testLikesData } from './pages/home.js?v=8.3.1';
import { trackVisit, renderVisitorStats } from './services/siteStats.js?v=8.3.1';
import { renderProfile } from './pages/profile.js?v=8.3.1';
import { renderAdmin } from './pages/admin.js?v=8.3.1';
import { renderArcade } from './pages/arcade-page.js?v=8.3.1';
import { renderTestExecution, renderResult } from './pages/tests.js?v=8.3.1';
import { renderAbout, renderPrivacy, renderTerms, renderContact, renderGuide, renderEncyclopedia } from './pages/info.js?v=8.3.1';
