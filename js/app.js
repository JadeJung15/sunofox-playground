    ...
    app.innerHTML = `
        <div class="card arcade-container fade-in">
            ...
            <details class="profile-details">
                <summary>🎫 인생역전! 럭키 복권</summary>
                <div class="game-zone lotto-section" style="background:linear-gradient(135deg, #f6d365 0%, #fda085 100%); color:white; border-radius:12px; padding:1.2rem;">
                    <div id="lotto-result" class="lotto-card" style="background:rgba(255,255,255,0.2); height:100px; display:flex; align-items:center; justify-content:center; margin-bottom:1rem; border-radius:10px; border:2px dashed #fff; font-weight:bold;">행운을 빌어요!</div>
                    <button id="lotto-btn" class="btn-primary" style="background:white; color:#fda085;">복권 구매하기 (500P)</button>
                </div>
            </details>

            <details class="profile-details">
                <summary>🎲 포인트 베팅 (홀짝/고저)</summary>
                <div class="game-zone" style="background:#fff3f5; border-radius:12px; padding:1.2rem;">
                    <div class="bet-input-area" style="margin-bottom: 1rem;">
                    ...
                    <div id="bet-result-msg" style="height:40px; display:flex; align-items:center; justify-content:center; text-align:center; font-weight:bold; margin-bottom:1rem;">베팅 금액을 정하고 선택하세요!</div>
                    <div style="display:grid; grid-template-columns: 1fr 1fr; gap:0.5rem;">
                        <button class="bet-btn btn-primary" data-game="oddeven" data-choice="odd" style="background:#6c5ce7; font-size:0.9rem;">홀</button>
                        <button class="bet-btn btn-primary" data-game="oddeven" data-choice="even" style="background:#a29bfe; font-size:0.9rem;">짝</button>
                        <button class="bet-btn btn-secondary" data-game="dice" data-choice="low" style="font-size:0.9rem;">저 (1-3)</button>
                        <button class="bet-btn btn-secondary" data-game="dice" data-choice="high" style="font-size:0.9rem;">고 (4-6)</button>
                    </div>
                </div>
            </details>
            ...
            <details class="profile-details">
                ...
                <div class="game-zone" style="background:var(--bg-color); border-radius:12px; padding:1.2rem;">
                    <div id="gacha-result" class="gacha-box" style="height:100px; display:flex; align-items:center; justify-content:center; margin-bottom:1rem; border:2px dashed var(--border-color); border-radius:10px;">준비 완료!</div>
            ...
            <details class="profile-details">
                ...
                <div class="alchemy-zone" style="border-radius:12px; padding:1.2rem;">
                    ...
                    <div id="alchemy-result" style="margin:1rem 0; font-weight:bold; text-align:center; min-height:20px;">재료를 확인해 주세요.</div>
                    <button id="alchemy-btn" class="btn-primary" style="background:#fff; color:#6c5ce7;">연금술 시작 (500P)</button>
                </div>
            </details>

            <details class="profile-details">
                <summary>⛏️ 단순 포인트 채굴</summary>
                <div class="game-zone" style="background:var(--bg-color); border-radius:12px; padding:1.2rem;">
