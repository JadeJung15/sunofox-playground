import { UserState, addPoints, postEconomyAction } from '../auth.js?v=8.6.0';
import { ITEM_VALUES } from '../constants/shops.js';
import { copyLink, saveAsStoryImage } from '../share.js?v=8.6.0';
import { TESTS } from '../tests-data.js?v=8.6.0';
import { renderTestCard } from './home.js?v=8.6.0';
...
async function rewardResult(dominantTrait) {
    const { getPetBuff } = await import('../auth.js?v=8.6.0');
