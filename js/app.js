...
const TESTS = [
    ...
    {
        id: 'p9', category: '성격', title: '워크 스타일 리포트', desc: '일이나 과제를 할 때 나타나는 당신만의 효율성과 협업 방식을 진단합니다.', thumb: unsplash('1497215842964-222b430dc094'),
        questions: [
    ...
    {
        id: 'p10', category: '성격', title: '자존감 온도 측정기', desc: '당신의 자존감 상태와 외부 자극에 대한 마음의 회복탄력성을 측정합니다.', thumb: unsplash('1535930749574-1399327ce78f'),
        questions: [
    ...
    {
        id: 'p11', category: '성격', title: '나의 멘탈 방어력 측정', desc: '당신의 정신적 맷집과 어려운 상황에서의 극복 능력을 7단계로 테스트합니다.', thumb: unsplash('1533090161767-e6ffed986c88'),
        questions: [
        ...
        results: {
            A: { title: '무적의 강철 멘탈', desc: '당신은 어떤 시련에도 쉽게 굴하지 않는 단단한 마음을 가졌습니다. 위기를 기회로 바꾸는 능력이 탁월합니다.', img: unsplash('1506126613408-eca57c42797c') },
            B: { title: '유리알 감성 소유자', desc: '당신은 섬세하고 공감 능력이 뛰어난 마음을 가졌습니다. 때로는 힘들 수 있지만 그만큼 세상을 아름답게 느낍니다.', img: unsplash('1516589174184-c68d8e5fcc4a') }
        }
    },
    {
        id: 'p12', category: '성격', title: '돈 관리 성향 테스트', desc: '당신의 소비 습관과 부를 대하는 태도를 통해 성격의 이면을 분석합니다.', thumb: unsplash('1554224155-6726b3ff858f'),
        questions: [
        ...
        results: {
            A: { title: '철저한 자산 전략가', desc: '당신은 이성적이고 장기적인 시각을 가진 분입니다. 안정적인 기반 위에서 목표를 달성하는 타입입니다.', img: unsplash('1579621970563-ebec7560ff3e') },
            B: { title: '현재를 즐기는 욜로족', desc: '당신은 현재의 경험과 행복을 가장 중요하게 생각합니다. 낙천적이고 관대한 성격이 주변을 즐겁게 합니다.', img: unsplash('1518186285589-2f7649de83e0') }
        }
    },
    {
        id: 'p13', category: '성격', title: '나의 리더십 온도', desc: '집단 속에서 당신이 보여주는 영향력과 리더 스타일을 분석합니다.', thumb: unsplash('1519389950473-47ba0277781c'),
        questions: [
        ...
        results: {
            A: { title: '카리스마 지휘관', desc: '당신은 목표 지향적이고 추진력이 강한 리더입니다. 명확한 비전으로 사람들을 행동하게 만드는 힘이 있습니다.', img: unsplash('1507679799987-c7377ec486e8') },
            B: { title: '포용력 있는 조율자', desc: '당신은 사람들의 마음을 얻는 부드러운 리더십을 가졌습니다. 당신과 함께라면 누구나 최고의 역량을 발휘합니다.', img: unsplash('1522202176988-66273c2fd55f') }
        }
    },
    {
        id: 'p14', category: '성격', title: '창의성 잠재력 테스트', desc: '당신의 두뇌가 문제를 해결하는 방식과 창의적인 발상을 분석합니다.', thumb: unsplash('1499750310107-5fef28a66643'),
        questions: [
        ...
        results: {
            A: { title: '자유로운 상상가', desc: '당신은 무한한 가능성을 꿈꾸는 예술가적 영혼을 가졌습니다. 당신의 독특한 시선이 세상에 새로운 가치를 더합니다.', img: unsplash('1456735190827-d1262f71b8a3') },
            B: { title: '실용적인 분석가', desc: '당신은 창의성을 현실로 구현해내는 뛰어난 능력을 가졌습니다. 체계적이고 실질적인 해결 능력이 당신의 강점입니다.', img: unsplash('1486312338219-ce68d2c6f44d') }
        }
    },
    {
        id: 'p15', category: '성격', title: '스트레스 해소 유형', desc: '지친 당신의 영혼을 채워주는 가장 효과적인 휴식 방법을 제안합니다.', thumb: unsplash('1515377905703-c4788e51af15'),
        questions: [
        ...
        results: {
            A: { title: '에너지 분출형', desc: '당신은 외부와의 교류를 통해 스트레스를 발산하는 타입입니다. 활동적인 취미가 당신의 삶에 활력을 줍니다.', img: unsplash('1511632765486-a01980e01a18') },
            B: { title: '내면 충전형', desc: '당신은 고요함 속에서 스스로를 정돈하며 에너지를 얻는 타입입니다. 정적인 휴식이 당신의 마음을 치유합니다.', img: unsplash('1499209974431-9dac3e5d9774') }
        }
    },
    {
        id: 'p16', category: '성격', title: '나의 소비 습관 MBTI', desc: '영수증에 담긴 당신의 성격과 미래 자산 흐름을 분석합니다.', thumb: unsplash('1556742044-3c52d6e88c62'),
        questions: [
        ...
        results: {
            A: { title: '알뜰한 살림꾼', desc: '당신은 경제 관념이 뚜렷하고 계획적인 분입니다. 차곡차곡 쌓이는 자산과 함께 미래가 밝습니다.', img: unsplash('1579621970563-ebec7560ff3e') },
            B: { title: '플렉스 마스터', desc: '당신은 시원시원한 성격과 통 큰 소비력을 가졌습니다. 현재의 행복을 극대화할 줄 아는 멋쟁이입니다.', img: unsplash('1518186285589-2f7649de83e0') }
        }
    },
    {
        id: 'p17', category: '성격', title: '공감 능력(EQ) 진단', desc: '타인의 감정을 읽는 당신의 따뜻한 시선과 소통의 깊이를 측정합니다.', thumb: unsplash('1552664730-d307ca884978'),
        questions: [
        ...
        results: {
            A: { title: '이성적인 해결사', desc: '당신은 감정보다는 상황을 객관적으로 파악하는 능력이 뛰어납니다. 실질적인 도움을 주는 든든한 조력자입니다.', img: unsplash('1552664730-d307ca884978') },
            B: { title: '감성 충만 힐러', desc: '당신은 타인의 슬픔과 기쁨을 온전히 함께할 줄 아는 따뜻한 분입니다. 당신의 존재 자체가 누군가에겐 큰 위로입니다.', img: unsplash('1522202176988-66273c2fd55f') }
        }
    },
    {
        id: 'p18', category: '성격', title: '나의 유머 코드 분석', desc: '당신이 사람들을 웃게 만드는 방식과 좋아하는 유머 스타일을 분석합니다.', thumb: unsplash('1516627145497-ae6968895b74'),
        questions: [
        ...
        results: {
            A: { title: '본투비 엔터테이너', desc: '당신은 타고난 유머 감각과 센스를 지닌 분입니다. 당신이 가는 곳마다 웃음꽃이 피어납니다.', img: unsplash('1511632765486-a01980e01a18') },
            B: { title: '고급스러운 블랙 유머가', desc: '당신은 관찰력이 예리하고 지적인 유머를 즐기는 분입니다. 짧지만 굵은 한마디로 사람들을 매료시킵니다.', img: unsplash('1543807535-eceef0bc6599') }
        }
    },
    {
        id: 'p19', category: '성격', title: '워커홀릭 지수 테스트', desc: '일과 삶의 균형을 맞추고 있는지, 당신의 열정이 어디로 향하고 있는지 진단합니다.', thumb: unsplash('1556761175-b413da4baf72'),
        questions: [
        ...
        results: {
            A: { title: '열정의 불꽃 질주가', desc: '당신은 목표를 향해 쉬지 않고 달려가는 에너자이저입니다. 성취감에서 가장 큰 행복을 느끼는 타입입니다.', img: unsplash('1519389950473-47ba0277781c') },
            B: { title: '여유로운 삶의 항해사', desc: '당신은 워라밸의 중요성을 알고 현재의 행복을 소중히 여깁니다. 마음의 평화가 당신의 가장 큰 자산입니다.', img: unsplash('1486312338219-ce68d2c6f44d') }
        }
    },
    {
        ...
        results: {
            A: { title: '깊은 내면의 탐구자', desc: '당신은 자신을 깊이 이해하고 사랑할 줄 아는 성숙한 영혼을 가졌습니다. 당신의 삶은 단단한 뿌리를 내리고 있습니다.', img: unsplash('1490730141103-6cac27aaab94') },
            B: { title: '피어나는 중인 성장판', desc: '당신은 현재 자신을 알아가는 소중한 과정 속에 있습니다. 조금만 더 자신을 믿어준다면 곧 활짝 꽃피울 것입니다.', img: unsplash('1532767153582-b1a0e5145009') }
        }
    },
    {
        id: 'v1', category: '얼굴', title: '퍼스널 무드 분석', desc: '당신의 이목구비가 풍기는 고유한 분위기와 매력을 정교하게 진단합니다.', thumb: unsplash('1506794778202-cad84cf45f1d'),
        questions: [
        ...
        results: {
            A: { title: '고혹적인 시크 클래식', desc: '당신은 뚜렷한 존재감과 강렬한 에너지를 지닌 비주얼을 가졌습니다. 사람들의 시선을 단번에 사로잡는 화려함이 당신의 무기입니다.', img: unsplash('1531746020798-e6953c6e8e04') },
            B: { title: '부드러운 내추럴 감성', desc: '당신은 편안하면서도 깊이 있는 무드를 지닌 비주얼을 가졌습니다. 볼수록 빠져드는 은은한 매력이 타인에게 편안함을 줍니다.', img: unsplash('1544005313-94ddf0286df2') }
        }
    },
    {
        id: 'v2', category: '얼굴', title: '이미지 동물 찾기', desc: '당신의 이목구비 비율을 통해 닮은꼴 동물의 관상과 이미지를 분석합니다.', thumb: unsplash('1516733725897-1aa73b87c8e8'),
        questions: [
        ...
        results: {
            A: { title: '도도한 고양이상', desc: '당신은 날렵하고 세련된 이미지를 가진 고양이상입니다. 도도해 보이지만 알수록 매력적인 반전 매력의 소유자입니다.', img: unsplash('1514888286974-6c03e2ca1dba') },
            B: { title: '포근한 강아지상', desc: '당신은 둥글둥글하고 선한 이미지를 가진 강아지상입니다. 누구에게나 호감을 주는 친근한 매력이 최고의 장점입니다.', img: unsplash('1537151608828-ea2b11777ee8') }
        }
    },
    {
        id: 'v3', category: '얼굴', title: '첫인상 매력 포인트', desc: '처음 만난 사람이 당신에게서 느끼는 가장 독보적인 매력을 찾아드립니다.', thumb: unsplash('1522075469751-3a6694fb2f61'),
        questions: [
        ...
        results: {
            A: { title: '지적인 아우라 마스터', desc: '당신은 성숙하고 이지적인 분위기로 상대방을 압도합니다. 신뢰감을 주는 눈빛이 당신의 가장 큰 무기입니다.', img: unsplash('1500648767791-00dcc994a43e') },
            B: { title: '햇살 같은 러블리 아이콘', desc: '당신은 밝고 긍정적인 에너지를 뿜어내는 비주얼을 가졌습니다. 당신의 웃음은 주변을 순식간에 환하게 만드는 힘이 있습니다.', img: unsplash('1534528741775-53994a69daeb') }
        }
    },
    {
        id: 'v4', category: '얼굴', title: '스마일 라인 진단', desc: '당신이 웃을 때 나타나는 입매와 볼 근육의 조화를 통해 최고의 미소를 찾아냅니다.', thumb: unsplash('1531123897727-8f129e1688ce'),
        questions: [
        ...
        results: {
            A: { title: '시원한 사이다 미소', desc: '당신은 보고만 있어도 기분이 좋아지는 청량한 미소를 가졌습니다. 자신감 넘치는 웃음이 당신의 비주얼을 완성합니다.', img: unsplash('1494790108377-be9c29b29330') },
            B: { title: '은은한 멜로 미소', desc: '당신은 마음을 설레게 하는 깊고 부드러운 미소를 가졌습니다. 눈빛과 입매가 조화를 이루어 묘한 분위기를 자아냅니다.', img: unsplash('1507003211169-0a1dd7228f2d') }
        }
    },
    {
        ...
        results: {
            A: { title: '세련된 보스턴 프레임', desc: '당신은 상단이 평평하고 하단이 둥근 보스턴 테가 가장 잘 어울립니다. 부드러움과 지적인 이미지를 동시에 챙길 수 있습니다.', img: unsplash('1513673048123-08505aa67997') },
            B: { title: '클래식 웰링턴 프레임', desc: '당신은 사각형 모양의 웰링턴 테가 비주얼의 균형을 완벽하게 잡아줍니다. 안정감 있고 신뢰도 높은 이미지를 연출해 보세요.', img: unsplash('1551028150-64b9f398f678') }
        }
    },
    {
    ...
    {
        id: 'v9', category: '얼굴', title: '피부 생기 온도 체크', desc: '당신의 피부 톤과 결을 통해 현재의 컨디션과 어울리는 관리법을 제안합니다.', thumb: unsplash('1556228578-0d85b1a4d571'),
        questions: [
        ...
        results: {
            A: { title: '고보습 물광 스킨', desc: '당신의 피부는 수분과 영양을 갈구하고 있습니다. 충분한 보습 관리만으로도 당신의 비주얼은 2배 이상 빛날 수 있습니다.', img: unsplash('1570172619394-2125115decd4') },
            B: { title: '깨끗한 도자기 스킨', desc: '당신은 기초가 탄탄하고 건강한 피부 결을 가졌습니다. 유수분 밸런스만 잘 유지한다면 투명한 비주얼을 계속 유지할 수 있습니다.', img: unsplash('1598440947619-2c35fc9aa908') }
        }
    },
    {
        id: 'v10', category: '얼굴', title: '토탈 비주얼 밸런스', desc: '얼굴의 조화로움과 대칭성을 통해 당신만의 황금 비율 포인트를 분석합니다.', thumb: unsplash('1500648767791-00dcc994a43e'),
        questions: [
        ...
        results: {
            A: { title: '강렬한 아방가르드 밸런스', desc: '당신은 개성 있는 부위들이 조화를 이루어 독보적인 인상을 형성합니다. 전형적인 틀을 벗어난 당신만의 매력을 믿으세요.', img: unsplash('1539571696357-5a69c17a67c6') },
            B: { title: '완벽한 클래식 하모니', desc: '당신은 어느 한 곳 튀지 않으면서도 전체적인 비율이 매우 안정적인 황금 비율의 소유자입니다. 조화로움이 당신의 가장 큰 힘입니다.', img: unsplash('1506794778202-cad84cf45f1d') }
        }
    },
    {
    ...
    {
        id: 'f3', category: '사주', title: '나의 평생 인복 총량', desc: '살아가면서 당신을 도와줄 귀인이 얼마나 있는지, 사람 복을 타고났는지 알아봅니다.', thumb: unsplash('1521791136064-7986c2920216'),
        questions: [
        ...
        results: {
            A: { title: '사람이 따르는 인복 대마왕', desc: '당신은 주변에는 항상 좋은 사람들이 넘쳐납니다. 당신의 밝은 에너지와 베푸는 마음이 귀인을 끌어당깁니다. 힘들 때마다 손을 내밀어 줄 조력자들이 평생 함께할 운명입니다.', img: unsplash('1511632765486-a01980e01a18') },
            B: { title: '스스로 개척하는 자수성가형', desc: '당신은 많은 사람보다는 진실된 소수의 관계를 소중히 여깁니다. 남에게 의지하기보다 스스로의 능력으로 길을 여는 강인함이 있습니다. 당신의 곁에 남은 사람들은 평생 가는 진짜 내 편입니다.', img: unsplash('1522202176988-66273c2fd55f') }
        }
    },
    {
    ...
    {
        id: 'f5', category: '사주', title: '미래 배우자 미리보기', desc: '사주 관법으로 분석한 당신의 미래 배우자 특징과 결혼 생활을 미리 확인해보세요.', thumb: unsplash('1515934751635-c81c6bc9a2d8'),
        questions: [
        ...
        results: {
            A: { title: '다정다감한 친구 같은 배우자', desc: '당신은 친구처럼 편안하고 대화가 잘 통하는 배우자를 만날 운명입니다. 소소한 일상을 공유하며 웃음이 끊이지 않는 행복한 결혼 생활을 하게 될 것입니다. 서로가 서로에게 가장 친한 베프가 되어줍니다.', img: unsplash('1516589174184-c68d8e5fcc4a') },
            B: { title: '능력 있는 든든한 멘토 배우자', desc: '당신은 배울 점이 많고 사회적으로 성공한 배우자를 만날 가능성이 높습니다. 당신을 리드해주고 안정적인 울타리가 되어줄 사람입니다. 서로의 꿈을 응원하며 함께 성장하는 멋진 부부가 될 것입니다.', img: unsplash('1552664730-d307ca884978') }
        }
    },
    {
        id: 'z1', category: '재미', title: '전생 유형 테스트', desc: '당신은 전생에 어떤 삶을 살았을까요? 무의식에 남은 기억을 통해 전생의 직업을 유추합니다.', thumb: unsplash('1518709268805-4e9042af9f23'),
        questions: [
        ...
        results: {
            A: { title: '화려한 삶을 즐긴 왕족/귀족', desc: '당신은 전생에 높은 신분으로 태어나 권력과 부를 누렸을 가능성이 큽니다. 현생에서도 고급스러운 취향과 리더십을 보여주며, 남들에게 주목받는 것을 즐기는 경향이 있습니다.', img: unsplash('1590053305130-13a500c328bd') },
