...
// 테스트 데이터베이스 (10가지 애니메이션 스타일 테스트 완성본)
const TESTS = [
    { 
        id: 'hero-origin', 
        category: '성격', 
    ...
    { 
        ...
        questions: [
            ...
            { q: '당신의 탐정 도구는?', options: [{ text: '변장 도구와 사교술', type: 'A' }, { text: '최첨단 돋보기와 분석기', type: 'B' }] },
            { q: '범인과 대면했을 때?', options: [{ text: '심리전을 통해 자백을 유도한다', type: 'A' }, { text: '완벽한 증거를 들이밀어 항복시킨다', type: 'B' }] },
            { q: '사건 해결 후 당신의 소감은?', options: [{ text: '진실은 언제나 하나!', type: 'A' }, { text: '모든 퍼즐이 맞춰졌군.', type: 'B' }] }
        ],
        results: {
            A: { title: '괴도 신사 탐정', desc: '창의적이고 직관적인 추리력을 가진 당신! 사람의 마음을 읽는 능력이 탁월하여 어려운 사건도 화려하게 해결합니다.' },
            B: { title: '명탐정 브레인', desc: '논리적이고 치밀한 분석력을 가진 당신! 작은 단서 하나 놓치지 않는 꼼꼼함으로 완벽하게 진실을 찾아냅니다.' }
        }
    },
    { 
        id: 'space-pilot', 
        ...
        questions: [
            ...
            { q: '당신이 더 신뢰하는 것은?', options: [{ text: '나의 경험과 조종 감각', type: 'Pilot' }, { text: '우주선의 인공지능과 데이터', type: 'Eng' }] },
            { q: '미션 성공 후 당신이 받는 칭찬은?', options: [{ text: '최고의 리더십이었어!', type: 'Pilot' }, { text: '완벽한 기술 지원이었어!', type: 'Eng' }] }
        ],
        results: {
            Pilot: { title: '무적의 함장님', desc: '결단력 있고 카리스마 넘치는 리더입니다. 위기 상황에서도 흔들리지 않고 모두를 목적지까지 이끄는 힘이 있습니다.' },
            Eng: { title: '천재 수석 엔지니어', desc: '분석적이고 지적인 기술 전문가입니다. 어떤 복잡한 기계라도 당신의 손을 거치면 완벽하게 작동하게 되는군요.' }
        }
    },
    { 
        id: 'food-chef', 
        ...
        questions: [
            ...
            { q: '당신의 시그니처 메뉴는?', options: [{ text: '추억을 부르는 소울 푸드', type: 'Heart' }, { text: '화려한 기술의 코스 요리', type: 'Tech' }] }
        ],
        results: {
            Heart: { title: '마음을 치유하는 요리사', desc: '당신의 요리에는 사람의 마음을 녹이는 따뜻함이 담겨 있습니다. 먹는 것만으로도 행복해지는 마법을 부리시네요!' },
            Tech: { title: '전설의 미식 장인', desc: '당신은 완벽을 추구하는 요리 예술가입니다. 정교한 기술과 창의적인 맛의 조합으로 사람들을 놀라게 만드는군요.' }
        }
    },
    { 
        id: 'magic-academy', 
        ...
        questions: [
            ...
            { q: '어떤 수업이 가장 듣고 싶나요?', options: [{ text: '하늘을 나는 빗자루 비행', type: 'G' }, { text: '비밀스러운 약초 조제', type: 'S' }] },
        ...
        results: {
            G: { title: '그리핀 라이온 기숙사', desc: '당신은 용기와 정의를 상징하는 사자의 심장을 가졌습니다. 어떤 역경도 굴하지 않고 헤쳐나갈 운명이네요!' },
            S: { title: '실버 스네이크 기숙사', desc: '당신은 야망과 지혜를 상징하는 뱀의 영리함을 가졌습니다. 치밀한 계획과 실력으로 세상을 뒤흔들 운명입니다.' }
        }
    },
    { 
        id: 'time-traveler', 
        ...
        questions: [
            ...
            { q: '미래의 기술 중 가장 탐나는 것은?', options: [{ text: '기억을 저장하는 기술', type: 'Past' }, { text: '은하계를 여행하는 기술', type: 'Future' }] },
            ...
            { q: '어떤 영화를 더 좋아하나요?', options: [{ text: '역사 로맨스물', type: 'Past' }, { text: 'SF 우주 미스터리물', type: 'Future' }] },
            { q: '인생의 모토는?', options: [{ text: '지나간 것은 아름답다', type: 'Past' }, { text: '내일은 오늘보다 나을 것이다', type: 'Future' }] }
        ],
        results: {
            Past: { title: '따뜻한 로맨티스트 여행자', desc: '당신은 감수성이 풍부하고 소중한 기억을 간직할 줄 아는 사람입니다. 과거의 아름다움을 현대에 전하는 메신저이기도 하네요.' },
            Future: { title: '혁신적인 개척자 여행자', desc: '당신은 호기심이 많고 변화를 즐기는 사람입니다. 항상 새로운 가능성을 꿈꾸며 미래를 설계하는 선구자적 면모가 있군요.' }
        }
    },
    { 
        id: 'pet-dragon', 
        ...
        questions: [
            ...
            { q: '보물을 지킬 때 당신의 태도는?', options: [{ text: '침입자를 단숨에 쫓아버린다', type: 'A' }, { text: '함정을 파서 스스로 포기하게 한다', type: 'B' }] },
        ...
        results: {
            A: { title: '태양의 골드 드래곤', desc: '당신은 압도적인 존재감과 리더십을 가졌습니다. 태양처럼 밝고 강한 에너지는 주변을 이끄는 힘이 됩니다.' },
            B: { title: '달빛의 실버 드래곤', desc: '당신은 우아하고 신비로운 매력을 가졌습니다. 차분한 통찰력과 지혜로 세상의 흐름을 읽어내는 능력이 탁월하군요.' }
        }
    }
];
...
function renderHome() {
    ...
    app.innerHTML = `
        <div class="ad-slot">광고 슬롯 - 메인 상단</div>
        <section class="portal-hero">
            <h1><span>7</span>Check</h1>
            <p>딱 7번의 선택으로 확인하는 애니메이션 스타일 테스트</p>
        </section>
        <div class="test-grid">
            ${filtered.map(t => `
        ...
        <div class="ad-slot">광고 슬롯 - 메인 하단</div>
    `;
}
...
function renderTestExecution(testId) {
    ...
    const updateStep = () => {
        ...
        app.innerHTML = `
            <div class="ad-slot">광고 슬롯 - 테스트 상단</div>
            ...
            <div class="ad-slot">광고 슬롯 - 테스트 하단</div>
        `;
...
function renderResult(testId, answers) {
    ...
    const result = test.results[winningType] || { title: '신비로운 존재', desc: '당신은 정의 내리기 어려운 독특한 매력을 가졌습니다.' };

    app.innerHTML = `
        <div class="ad-slot">광고 슬롯 - 결과 상단</div>
        ...
        <div class="ad-slot">광고 슬롯 - 결과 하단</div>
    `;
