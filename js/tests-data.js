export const TESTS = [
    {
        id: 'p1', category: '성격', title: '나의 숨겨진 아우라 컬러', desc: '7단계 심층 질문으로 당신만의 고유한 성향과 아우라를 분석합니다.', thumb: 'https://images.pexels.com/photos/158063/beyer-optical-glass-lens-158063.jpeg?auto=compress&cs=tinysrgb&w=800',
        questions: [
        ...
        results: {
            energy: { title: '타오르는 태양의 레드', desc: '당신은 주변 사람들에게 에너지를 전파하는 강력한 아우라를 가졌습니다. 리더십이 뛰어나고 솔직한 표현이 매력적입니다.', img: 'https://images.pexels.com/photos/158063/beyer-optical-glass-lens-158063.jpeg?auto=compress&cs=tinysrgb&w=800', color: '#ef4444', tags: ['#열정', '#리더십', '#에너자이저'] },
            ...
            empathy: { title: '고요한 숲의 그린', desc: '주변을 편안하게 만드는 따뜻한 공감 능력의 소유자입니다. 당신과 함께라면 누구나 위로를 얻습니다.', img: 'https://images.pexels.com/photos/158028/beyer-optical-glass-lens-158028.jpeg?auto=compress&cs=tinysrgb&w=800', color: '#10b981', tags: ['#힐러', '#평화주의자', '#리스너'] },
            creativity: { title: '신비로운 보랏빛 밤', desc: '독창적인 시선으로 세상을 바라보는 예술가적 영혼입니다. 남들이 보지 못하는 가능성을 찾아냅니다.', img: 'https://images.pexels.com/photos/1161547/pexels-photo-1161547.jpeg?auto=compress&cs=tinysrgb&w=800', color: '#8b5cf6', tags: ['#아이디어', '#아티스트', '#독창성'] }
        }
    },
    {
