export const TESTS = [
    {
        ...
        thumb: 'https://scontent-tpe1-1.cdninstagram.com/v/t51.2885-15/491508562_17899630527177267_864338183336279557_n.webp?efg=eyJ2ZW5jb2RlX3RhZyI6InRocmVhZHMuRkVFRC5pbWFnZV91cmxnZW4uMzQweDM0MC5zZHIuZjc1NzYxLmRlZmF1bHRfaW1hZ2UuYzIifQ&_nc_ht=scontent-tpe1-1.cdninstagram.com&_nc_cat=103&_nc_oc=Q6cZ2QHTXknICwoUOPd8i9GNC2_wxeng5pWYKCY_Jcb8ZGSjpssyH0PKo0L-6IsH1hYznP8&_nc_ohc=fFITkIfMz-IQ7kNvwEg4qe3&_nc_gid=PmCPZUZV9RDNO08b8SMZTw&edm=APs17CUBAAAA&ccb=7-5&ig_cache_key=MzYxOTA3MDI2NzQ2ODY2ODA4Mg%3D%3D.3-ccb7-5&oh=00_AftkQ18dvym3dJz6XFYyd2uGLXGurXvWFhdq6b66Jp1XZg&oe=69A5E5D8&_nc_sid=10d13b',
 ...
 category: '성격', title: '나의 숨겨진 아우라 컬러', desc: '7단계 심층 질문으로 당신만의 고유한 성향과 아우라를 분석합니다.', thumb: 'https://images.unsplash.com/photo-1550684848-fac1c5b4e853?auto=format&fit=crop&w=800&q=80',
    ...
    },
    {
        ...
        questions: [
            {
                q: '밤에 단톡방 알림이 127개 쌓였다. 당신의 첫 반응은?',
                options: [
                    { text: '스크롤 내리다 포기하고 최근 5줄만 본다', type: 'T1' },
                    { text: '일단 사진부터 눌러서 무슨 난리인지 본다', type: 'T2' },
                    { text: '보이스룸부터 켜져 있는지 확인한다', type: 'T3' },
                    { text: '읽씹처럼 보이지 않게 ㅎㅎ 하나 남긴다', type: 'T4' }
                ]
            },
            {
                q: '누가 갑자기 "잠원지구에서 만나"라고 한다. 당신은?',
                options: [
                    { text: '어디냐고 묻기 전에 일단 갈 수 있다고 말한다', type: 'T5' },
                    { text: '거긴 어디래 하고 현실 체크부터 한다', type: 'T6' },
                    { text: '샵검색으로 근처 맛집을 던지며 흐름을 바꾼다', type: 'T7' },
                    { text: '난 집이야를 속으로 삼키고 지도 앱만 켠다', type: 'T8' }
                ]
            },
            {
                q: '보이스룸이 갑자기 열렸다. 당신 캐릭터는?',
                options: [
                    { text: '마이크는 못 켜도 듣방은 꼬박꼬박 들어간다', type: 'T9' },
                    { text: '입장 3분 만에 별명 붙이고 분위기 장악한다', type: 'T10' },
                    { text: '잠깐 들어왔다가 "팅겼.." 하고 사라진다', type: 'T11' },
                    { text: '누워서 컴터 켜놓고 폰으로만 반응한다', type: 'T12' }
                ]
            },
            {
                q: '단톡에 사진 15장이 올라왔다. 당신은?',
                options: [
                    { text: '한 장 한 장 확대하면서 혹평할 준비를 한다', type: 'T13' },
                    { text: '일단 예쁘다 귀엽다부터 쏟아낸다', type: 'T14' },
                    { text: '엉뚱한 캡션 하나로 댓글창을 뒤집는다', type: 'T15' },
                    { text: '아무 말 없이 저장만 하고 뒤늦게 나타난다', type: 'T1' }
                ]
            },
            {
                q: '대화가 갑자기 음식 얘기로 번졌다. 당신의 역할은?',
                options: [
                    { text: '내가 아는 맛집 링크와 샵검색을 폭격한다', type: 'T7' },
                    { text: '사진 보고 "똥같애" 같은 솔직평이 먼저 나온다', type: 'T13' },
                    { text: '동물원 가자, 짜장면 가자 하며 약속을 키운다', type: 'T5' },
                    { text: '배고파지니까 조용히 배달앱부터 켠다', type: 'T8' }
                ]
            },
            {
                q: '누가 아재개그를 던졌다. 당신은?',
                options: [
                    { text: '정답 맞혀줘서 버릇 나빠진다 소리 듣는다', type: 'T6' },
                    { text: '이모티콘만 날리고 지나간다', type: 'T4' },
                    { text: '하이~ 하면서 다른 사람 인사까지 이어준다', type: 'T14' },
                    { text: '그 농담보다 센 드립으로 판을 갈아엎는다', type: 'T15' }
                ]
            },
            {
                q: '새벽 1시가 넘었는데도 채팅이 안 끝난다. 당신은?',
                options: [
                    { text: '나 먼저 잘게 친구들 하고 정리 멘트를 친다', type: 'T2' },
                    { text: '보이스룸 종료됐다가 다시 켜져도 계속 본다', type: 'T3' },
                    { text: '아직 할 말 남아서 조용히 한 줄씩 더 던진다', type: 'T10' },
                    { text: '이미 잠든 줄 알았는데 갑자기 다시 등장한다', type: 'T11' }
                ]
            },
            {
                q: '이 방 제목이 "순하고 귀여운 사람들 놀러와"라면, 당신은?',
                options: [
                    { text: '순한 척하지만 사실 제일 기억 오래 남는 타입', type: 'T12' },
                    { text: '귀엽긴 한데 말 한마디가 묘하게 쎄다', type: 'T9' },
                    { text: '제목과 현실의 괴리를 누구보다 빨리 눈치챈다', type: 'T6' },
                    { text: '그래도 결국 이 방의 정을 못 끊고 눌러앉는다', type: 'T2' }
                ]
            }
        ],
        results: {
            T1: {
                title: '밀린 대화 3줄 요약러',
                desc: '당신은 단톡방 전체를 정독하지 않아도 감으로 상황을 파악하는 생존형입니다. 다 읽은 척 자연스럽게 섞이지만 사실 핵심만 야무지게 먹고 빠지는 타입입니다.',
                img: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=800&q=80',
                tags: ['#요약천재', '#눈치빠름', '#읽은척장인'],
                color: '#64748b'
            },
            T2: {
                title: '정 붙으면 못 나가는 눌러앉기 요정',
                desc: '당신은 처음엔 조용하지만 어느 순간 방의 생활 주민이 됩니다. 잘 자 인사도 예쁘게 하고 사진도 잘 봐주고, 결국 오래 남는 사람은 당신 같은 타입입니다.',
                img: 'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=800&q=80',
                tags: ['#정많음', '#출석요정', '#은근핵심멤버'],
                color: '#f59e0b'
            },
            T3: {
                title: '보이스룸 상주 청취자',
                desc: '당신은 말을 많이 안 해도 접속 자체로 존재감을 남깁니다. 방이 열리면 일단 들어가 있고, 종료되면 허전해서 다시 켜졌는지 확인하는 청취 중독형입니다.',
                img: 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?auto=format&fit=crop&w=800&q=80',
                tags: ['#듣방전문', '#보룸중독', '#출석왕'],
                color: '#3b82f6'
            },
            T4: {
                title: '이모티콘으로 세상 다 사는 타입',
                desc: '당신은 긴 설명 대신 타이밍 좋은 이모티콘 한 방으로 존재감을 남깁니다. 말은 적어도 리액션 센스가 좋아서, 없으면 괜히 방이 허전해지는 캐릭터입니다.',
                img: 'https://images.unsplash.com/photo-1516321497487-e288fb19713f?auto=format&fit=crop&w=800&q=80',
                tags: ['#이모티콘장인', '#짧고굵게', '#리액션캐리'],
                color: '#ec4899'
            },
            T5: {
                title: '갑분 번개 추진 본부장',
                desc: '당신은 채팅 몇 줄 만에 약속을 현실로 만드는 추진형입니다. 어디냐고 묻기도 전에 모이자고 하고, 만나면 또 다음 약속까지 잡아버리는 실행력 과다 보유자입니다.',
                img: 'https://images.unsplash.com/photo-1529156069898-49953e39b3ac?auto=format&fit=crop&w=800&q=80',
                tags: ['#번개소환', '#실행파', '#모임주도'],
                color: '#22c55e'
            },
            T6: {
                title: '현실 체크하는 팩트 자판기',
                desc: '당신은 다들 텐션에 취해 있을 때 "근데 거기 어디야?"를 던지는 사람입니다. 덕분에 흐름은 잠깐 깨지지만, 이상하게 방 전체가 당신 같은 사람 하나는 꼭 필요합니다.',
                img: 'https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&w=800&q=80',
                tags: ['#현실수호자', '#정신줄담당', '#팩트체크'],
                color: '#0f172a'
            },
            T7: {
                title: '샵검색 맛집 레이더',
                desc: '당신은 대화가 어디로 튀든 결국 검색어와 맛집으로 수렴시키는 타입입니다. 링크 하나, 샵검색 하나로 판을 키우고 사람들 배를 고프게 만드는 위험한 능력이 있습니다.',
                img: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&w=800&q=80',
                tags: ['#샵검색중독', '#맛집소환', '#주제전환천재'],
                color: '#f97316'
            },
            T8: {
                title: '조용한데 생존력 강한 관전러',
                desc: '당신은 시끄러운 와중에도 본인 페이스를 잃지 않는 타입입니다. 말수는 적지만 흐름은 다 보고 있고, 배달앱 켜며 속으로만 바쁘게 움직이는 실속파입니다.',
            ...
            T9: {
                title: '순한 척하는 은근 독설가',
                desc: '당신은 겉으로는 말랑한데 한 줄이 이상하게 오래 남는 타입입니다. 세게 말한 것도 아닌데 사람들 머릿속에 남아서, 뒤늦게 "그 말 좀 웃겼다" 소리 듣는 캐릭터입니다.',
                img: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=800&q=80',
                tags: ['#은근쎔', '#한줄타격', '#말랑독설'],
                color: '#8b5cf6'
            },
            T10: {
                title: '방 분위기 장악하는 수다 엔진',
                desc: '당신은 등장만 해도 단톡 속도가 빨라지는 타입입니다. 별명 붙이고 반응 끌어내고 대화를 끝없이 이어가서, 없으면 방 온도가 눈에 띄게 내려갑니다.',
                img: 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=800&q=80',
                tags: ['#말발좋음', '#분위기메이커', '#채팅가속기'],
                color: '#06b6d4'
            },
            T11: {
                title: '팅겼다가 부활하는 회귀형',
                desc: '당신은 사라져도 완전히 사라지지 않습니다. 잠든 줄 알았는데 다시 나타나고, 튕긴 줄 알았는데 또 들어오며 방에 묘한 생명력을 추가하는 회귀형 플레이어입니다.',
                img: 'https://images.unsplash.com/photo-1516321310764-8d15c2f6a5f9?auto=format&fit=crop&w=800&q=80',
                tags: ['#회귀캐', '#재등장전문', '#끈질긴존재감'],
                color: '#14b8a6'
            },
            T12: {
                title: '누워서 다 보는 생활형 접속자',
                desc: '당신은 체력은 아끼되 재미는 놓치지 않는 타입입니다. 겉보기엔 늘 누워 있는데 묘하게 방 흐름은 다 알고 있어서, 게으름과 참여를 절묘하게 양립합니다.',
                img: 'https://images.unsplash.com/photo-1515377905703-c4788e51af15?auto=format&fit=crop&w=800&q=80',
                tags: ['#누워서참여', '#생활형접속', '#귀찮지만궁금'],
                color: '#a855f7'
            },
            T13: {
                title: '사진 혹평 심사위원',
                desc: '당신은 올라온 사진을 그냥 못 넘깁니다. 확대하고 비교하고 코멘트까지 얹어서 모두를 웃기거나 당황시키는 타입인데, 이상하게 본인도 제일 재밌어합니다.',
                img: 'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?auto=format&fit=crop&w=800&q=80',
                tags: ['#혹평전문', '#확대장인', '#심사위원모드'],
                color: '#ef4444'
            },
            T14: {
                title: '안녕봇 감성 담당',
                desc: '당신은 누구 들어오면 인사하고, 잘 자라 하고, 예쁘다 귀엽다를 자연스럽게 말하는 타입입니다. 방의 순한 이미지가 아직 남아 있다면 그건 거의 당신 덕분입니다.',
                img: 'https://images.unsplash.com/photo-1516589178581-6cd7833ae3b2?auto=format&fit=crop&w=800&q=80',
                tags: ['#인사요정', '#다정함담당', '#말랑캐'],
                color: '#fb7185'
            },
            T15: {
                title: '판 뒤집는 병맛 드립러',
                desc: '당신은 흐름이 잠깐 느슨해지면 이상한 비유 한 줄로 방을 터뜨리는 타입입니다. 어디서 그런 표현을 주워왔는지 모르겠는데, 결국 사람들이 제일 오래 기억하는 건 당신 드립입니다.',
                img: 'https://images.unsplash.com/photo-1516627145497-ae6968895b74?auto=format&fit=crop&w=800&q=80',
                tags: ['#병맛드립', '#판뒤집기', '#기억조작범'],
                color: '#eab308'
            }
        }
    },
    ...
    {
        id: 'w1', category: '월급 루팡', title: '회사에서 나는 몇 급 월급 루팡인가', desc: '일하는 척은 기본, 시간 순삭 스킬은 옵션. 당신의 사무실 생존형 루팡 레벨을 판정합니다.', thumb: 'https://images.unsplash.com/photo-1497366754035-f200968a6e72?auto=format&fit=crop&w=800&q=80',
        questions: [
            { q: '오전 10시 17분, 업무창과 메신저창을 동시에 띄워둔 당신의 표정은?', options: [{ text: '이미 바쁜 척 표정 장착 완료', scores: { energy: 2, logic: 1 } }, { text: '조용히 브라우저 탭 정리 중', scores: { logic: 2, empathy: 1 } }, { text: '멍 때리다 누가 지나가면 갑자기 클릭', scores: { creativity: 2, energy: 1 } }, { text: '진짜 일하는 사람처럼 보여서 본인도 속음', scores: { empathy: 2, logic: 1 } }] },
            { q: '회의 초대 메일이 왔을 때 가장 먼저 드는 생각은?', options: [{ text: '좋아, 1시간 순삭 찬스', scores: { energy: 2, creativity: 1 } }, { text: '카메라만 안 켜면 버틸 수 있다', scores: { logic: 2, empathy: 1 } }, { text: '질문만 안 받으면 된다', scores: { empathy: 2, creativity: 1 } }, { text: '회의록처럼 보이는 메모장부터 켠다', scores: { logic: 2, energy: 1 } }] },
            { q: '점심 먹고 2시쯤 당신의 정신 상태는?', options: [{ text: '커피로 영혼 강제 부활', scores: { energy: 2, logic: 1 } }, { text: '모니터 보며 눈만 뜨고 있음', scores: { empathy: 2, logic: 1 } }, { text: '갑자기 인생 계획 세우기 시작', scores: { creativity: 2, empathy: 1 } }, { text: '엑셀 열어놓고 속으로 노래 부름', scores: { creativity: 2, energy: 1 } }] },
            { q: '상사가 지나갈 때 당신의 반응속도는?', options: [{ text: '0.3초 안에 Alt+Tab 가능', scores: { logic: 2, energy: 1 } }, { text: '이미 업무 화면이라 여유 있음', scores: { empathy: 2, logic: 1 } }, { text: '놀라서 괜히 마우스만 흔듦', scores: { energy: 2, creativity: 1 } }, { text: '오히려 먼저 아는 척 인사함', scores: { empathy: 2, energy: 1 } }] },
            { q: '가장 즐겨 쓰는 회사용 멘트는?', options: [{ text: '지금 정리해서 드리겠습니다', scores: { logic: 2, empathy: 1 } }, { text: '한 번 더 체크해보고 공유드릴게요', scores: { empathy: 2, logic: 1 } }, { text: '이 부분은 조금 더 디벨롭해보겠습니다', scores: { creativity: 2, logic: 1 } }, { text: '오늘 안에 방향만 잡아보겠습니다', scores: { energy: 2, creativity: 1 } }] },
            { q: '회사 PC로 가장 오래 할 수 있는 건?', options: [{ text: '창 최소화하면서 뉴스 보기', scores: { logic: 2, creativity: 1 } }, { text: '단톡 알림 훑으며 공감하기', scores: { empathy: 2, energy: 1 } }, { text: '엑셀 같은 화면 켜두고 딴짓하기', scores: { logic: 2, energy: 1 } }, { text: '할 일 정리하다 갑자기 딴 생각하기', scores: { creativity: 2, empathy: 1 } }] },
            { q: '당신의 진짜 사무실 초능력은?', options: [{ text: '바쁜 사람처럼 걷기', scores: { energy: 2, empathy: 1 } }, { text: '들켜도 안 들킨 척하기', scores: { logic: 2, empathy: 1 } }, { text: '없는 일도 있어 보이게 말하기', scores: { creativity: 2, energy: 1 } }, { text: '묘하게 미움 안 받기', scores: { empathy: 2, creativity: 1 } }] }
        ],
        results: {
            energy: { title: '전광석화 탭전환 루팡', desc: '당신은 정적인 잠수형이 아니라 반응속도로 사무실을 지배하는 타입입니다. 누가 와도 화면 전환, 표정 관리, 자리 이동까지 매끄럽고 빠릅니다. 들키지 않는 것이 아니라 들킬 틈을 안 주는 프로 월급 루팡입니다.', img: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=800&q=80', color: '#0f766e', tags: ['#반응속도', '#탭전환', '#눈치플레이'] },
            logic: { title: '엑셀 위장술 마스터', desc: '당신은 루팡도 계획적으로 합니다. 가짜 업무창, 정리된 메모, 그럴듯한 말투까지 준비돼 있어 누가 봐도 일하는 사람처럼 보입니다. 사실 가장 무서운 건 열심히 안 해도 열심히 한 것처럼 보이는 이 정교함입니다.', img: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=800&q=80', color: '#0f766e', tags: ['#위장전문', '#정리형', '#엑셀페르소나'] },
            empathy: { title: '미움 안 받는 평화형 루팡', desc: '당신은 혼자만 편한 루팡이 아니라, 주변 공기까지 읽으며 살아남는 타입입니다. 적당히 반응하고, 적당히 공감하고, 적당히 존재감을 유지해 아무도 크게 경계하지 않습니다. 회사 생활 오래 가는 사람의 기술이 여기에 있습니다.', img: 'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?auto=format&fit=crop&w=800&q=80', color: '#14b8a6', tags: ['#평화주의', '#공기지배', '#무난최강'] },
            creativity: { title: '딴생각 생산성 천재', desc: '겉으로는 루팡인데 속으로는 늘 별별 시뮬레이션이 돌아갑니다. 업무 중 갑자기 여행 계획, 저녁 메뉴, 인생 리브랜딩까지 동시에 굴러가며 시간을 녹입니다. 회사가 당신의 몸을 잡아도 정신은 이미 자유입니다.', img: 'https://images.unsplash.com/photo-1496171367470-9ed9a91ea931?auto=format&fit=crop&w=800&q=80', color: '#14b8a6', tags: ['#딴생각고수', '#정신은퇴근', '#은근중독'] }
        }
    },
    {
        id: 'w2', category: '월급 루팡', title: '회의 중 살아남는 직장인 캐릭터 테스트', desc: '말은 안 해도 존재감은 남겨야 한다. 회의 시간 당신의 생존 포지션을 찾아드립니다.', thumb: 'https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&w=800&q=80',
        questions: [
            { q: '회의 시작 3분 전, 당신이 제일 먼저 확인하는 건?', options: [{ text: '오늘 꼭 말해야 하는 포인트', scores: { logic: 2, energy: 1 } }, { text: '카메라 켜도 괜찮은 얼굴인지', scores: { empathy: 2, creativity: 1 } }, { text: '언제 끝나는지', scores: { creativity: 2, empathy: 1 } }, { text: '혹시 나한테 질문 오는지', scores: { energy: 2, logic: 1 } }] },
            { q: '누군가 갑자기 의견을 묻는다면?', options: [{ text: '핵심만 짧고 강하게 말한다', scores: { energy: 2, logic: 1 } }, { text: '앞사람 의견을 예쁘게 정리해서 말한다', scores: { empathy: 2, logic: 1 } }, { text: '애매하지만 있어 보이는 문장으로 버틴다', scores: { creativity: 2, logic: 1 } }, { text: '음... 조금 더 생각해보면 좋을 것 같습니다', scores: { logic: 2, empathy: 1 } }] },
            { q: '가장 싫은 회의 유형은?', options: [{ text: '결론 없이 길기만 한 회의', scores: { logic: 2, energy: 1 } }, { text: '다들 예민해서 눈치 보는 회의', scores: { empathy: 2, creativity: 1 } }, { text: '자료만 읽고 끝나는 회의', scores: { creativity: 2, energy: 1 } }, { text: '갑자기 브레인스토밍 시키는 회의', scores: { energy: 2, empathy: 1 } }] },
            { q: '회의 중 몰래 가장 많이 하는 행동은?', options: [{ text: '메모하는 척 핵심 단어만 적기', scores: { logic: 2, empathy: 1 } }, { text: '표정으로 공감 리액션 하기', scores: { empathy: 2, energy: 1 } }, { text: '딴 생각하다 갑자기 정신 차리기', scores: { creativity: 2, empathy: 1 } }, { text: '언제 내 차례인지 촉 세우기', scores: { energy: 2, logic: 1 } }] },
            { q: '당신이 선호하는 회의 엔딩은?', options: [{ text: '할 일 명확하게 정리되고 종료', scores: { logic: 2, energy: 1 } }, { text: '분위기 좋게 웃으며 종료', scores: { empathy: 2, creativity: 1 } }, { text: '뭔가 결정된 척 흐지부지 종료', scores: { creativity: 2, logic: 1 } }, { text: '내 할 말만 하고 후련하게 종료', scores: { energy: 2, empathy: 1 } }] },
            { q: '당신의 회의 필살기는?', options: [{ text: '정리형 한마디로 존재감 챙기기', scores: { logic: 2, empathy: 1 } }, { text: '분위기 살리는 맞장구', scores: { empathy: 2, energy: 1 } }, { text: '뜬금없지만 재밌는 비유', scores: { creativity: 2, energy: 1 } }, { text: '중요한 순간에만 등장하기', scores: { energy: 2, logic: 1 } }] },
            { q: '회의가 끝난 뒤 당신의 모습은?', options: [{ text: '결론 정리해서 바로 움직임', scores: { logic: 2, energy: 1 } }, { text: '사람들 반응 먼저 살핀다', scores: { empathy: 2, logic: 1 } }, { text: '방금 회의보다 간식이 더 생각난다', scores: { creativity: 2, empathy: 1 } }, { text: '나 오늘 꽤 잘 버텼다 싶다', scores: { energy: 2, creativity: 1 } }] }
        ],
        results: {
            energy: { title: '짧고 굵게 치고 빠지는 사람', desc: '당신은 회의 내내 존재감을 뿌리는 타입은 아니지만, 필요한 순간에는 확실히 등장합니다. 말 수는 많지 않아도 타이밍을 잡는 감각이 좋고, 회의가 지루해질 때 판을 한 번 흔들 줄 압니다. 직장인 실전형 생존 캐릭터입니다.', img: 'https://images.unsplash.com/photo-1517048676732-d65bc937f952?auto=format&fit=crop&w=800&q=80', color: '#0f766e', tags: ['#치고빠지기', '#실전형', '#타이밍고수'] },
            logic: { title: '회의 정리본 인간화', desc: '당신은 떠드는 사람보다 정리하는 사람에 가깝습니다. 말 한 번 하면 전체 맥락이 정리되고, 회의록에 그대로 들어갈 문장이 나옵니다. 존재감이 조용해서 그렇지, 사실 회의장에서 제일 유용한 사람일 가능성이 큽니다.', img: 'https://images.unsplash.com/photo-1516321165247-4aa89a48be28?auto=format&fit=crop&w=800&q=80', color: '#115e59', tags: ['#정리본', '#실무캐리', '#핵심요약'] },
            empathy: { title: '분위기 살리는 공감 요정', desc: '당신은 회의의 내용만큼 공기도 봅니다. 누가 말 막히는지, 누가 예민한지, 어떤 말이 부드럽게 먹히는지 감각적으로 알고 있어 판을 부드럽게 만듭니다. 회의장의 숨은 윤활유가 바로 당신입니다.', img: 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=800&q=80', color: '#14b8a6', tags: ['#분위기메이커', '#공감센서', '#윤활유'] },
            creativity: { title: '정신은 이미 퇴근한 비유 천재', desc: '당신은 회의에 앉아 있지만 머릿속은 늘 다른 세계를 넘나듭니다. 그런데 가끔 꺼내는 비유나 엉뚱한 포인트가 이상하게 맞아떨어져 사람들을 웃기거나 깨웁니다. 집중력은 들쑥날쑥하지만 존재감은 묘하게 남습니다.', img: 'https://images.unsplash.com/photo-1497366412874-3415097a27e7?auto=format&fit=crop&w=800&q=80', color: '#14b8a6', tags: ['#비유천재', '#정신퇴근', '#묘한존재감'] }
        }
    },
    {
        id: 'w3', category: '월급 루팡', title: '퇴근 직전 존버력 보고서', desc: '남은 47분, 32분, 18분을 어떻게 버티는지 보면 당신의 직장인 본성이 드러납니다.', thumb: 'https://images.unsplash.com/photo-1524758631624-e2822e304c36?auto=format&fit=crop&w=800&q=80',
        questions: [
            { q: '퇴근 1시간 전 갑자기 추가 업무가 들어오면?', options: [{ text: '오늘 가능한 선까지 쳐내본다', scores: { energy: 2, logic: 1 } }, { text: '우선순위 나눠서 내일로 넘길 것 고른다', scores: { logic: 2, empathy: 1 } }, { text: '영혼이 먼저 퇴근해서 반응이 느리다', scores: { creativity: 2, empathy: 1 } }, { text: '표정 관리부터 시작한다', scores: { empathy: 2, energy: 1 } }] },
            { q: '퇴근 30분 전 당신이 가장 자주 보는 것은?', options: [{ text: '시계', scores: { energy: 2, empathy: 1 } }, { text: '메신저 미확인 알림', scores: { logic: 2, energy: 1 } }, { text: '집 가서 먹을 메뉴', scores: { creativity: 2, empathy: 1 } }, { text: '상사 자리 움직임', scores: { empathy: 2, logic: 1 } }] },
            { q: '마지막 시간에 가장 잘 되는 일은?', options: [{ text: '오히려 집중력 몰빵', scores: { energy: 2, logic: 1 } }, { text: '정리, 정돈, 마감 체크', scores: { logic: 2, empathy: 1 } }, { text: '퇴근 후 삶 계획 세우기', scores: { creativity: 2, energy: 1 } }, { text: '사람들 눈치 따라 타이밍 맞추기', scores: { empathy: 2, logic: 1 } }] },
            { q: '퇴근 직전 가장 위험한 상황은?', options: [{ text: '상사가 부르는 소리', scores: { energy: 2, empathy: 1 } }, { text: '메일 한 통 더 도착', scores: { logic: 2, energy: 1 } }, { text: '갑자기 잡담 시작한 동료', scores: { creativity: 2, empathy: 1 } }, { text: '다들 안 일어나는 분위기', scores: { empathy: 2, logic: 1 } }] },
            { q: '퇴근 버튼을 눈앞에 두고 당신의 마음은?', options: [{ text: '지금 뛰면 6분 절약 가능', scores: { energy: 2, creativity: 1 } }, { text: '마지막까지 깔끔히 하고 나가자', scores: { logic: 2, empathy: 1 } }, { text: '내 영혼은 이미 집 현관 앞', scores: { creativity: 2, energy: 1 } }, { text: '혼자 먼저 일어나도 되나 계산 중', scores: { empathy: 2, logic: 1 } }] },
            { q: '당신의 존버 자세는?', options: [{ text: '모니터 정면 응시', scores: { logic: 2, energy: 1 } }, { text: '한숨 삼키며 미소 유지', scores: { empathy: 2, energy: 1 } }, { text: '의자에 영혼 없이 기대기', scores: { creativity: 2, empathy: 1 } }, { text: '다리를 떨며 카운트다운', scores: { energy: 2, creativity: 1 } }] },
            { q: '퇴근 후 가장 먼저 하고 싶은 건?', options: [{ text: '밖으로 나가서 바로 리프레시', scores: { energy: 2, empathy: 1 } }, { text: '할 일 다 끝냈다는 안도감 즐기기', scores: { logic: 2, empathy: 1 } }, { text: '침대와 하나 되기', scores: { creativity: 2, empathy: 1 } }, { text: '오늘 힘들었다고 누군가에게 말하기', scores: { empathy: 2, creativity: 1 } }] }
        ],
        results: {
            energy: { title: '퇴근 직전 스퍼트형', desc: '당신은 퇴근이 가까워질수록 이상하게 에너지가 도는 타입입니다. 빨리 끝내고 나가겠다는 의지가 집중력으로 전환되며, 마지막 30분에 하루치 마감 감각이 살아납니다. 직장인계의 막판 몰아치기 장인입니다.', img: 'https://images.unsplash.com/photo-1504384308090-c894fdcc538d?auto=format&fit=crop&w=800&q=80', color: '#0f766e', tags: ['#막판스퍼트', '#퇴근부스터', '#끝내고나간다'] },
            logic: { title: '마감선 정리 전문가', desc: '당신은 존버도 체계적으로 합니다. 오늘 끝낼 것과 내일 넘길 것을 칼같이 나누고, 퇴근 전 마지막 체크를 하며 자신만의 질서를 유지합니다. 가장 덜 티 나고 가장 오래 살아남는 유형입니다.', img: 'https://images.unsplash.com/photo-1484480974693-6ca0a78fb36b?auto=format&fit=crop&w=800&q=80', color: '#115e59', tags: ['#마감관리', '#체계적존버', '#실속파'] },
            empathy: { title: '눈치 보며 타이밍 잡는 퇴근러', desc: '당신은 단순히 시계만 보는 사람이 아니라, 주변 움직임과 공기를 함께 읽는 타입입니다. 누가 아직 안 일어났는지, 지금 나가면 어떤지, 자연스러운 타이밍이 언제인지 계산합니다. 사회생활 최적화 존버력이 상당합니다.', img: 'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?auto=format&fit=crop&w=800&q=80', color: '#14b8a6', tags: ['#눈치퇴근', '#공기판독', '#사회생활장인'] },
            creativity: { title: '영혼 선퇴근 몽상가', desc: '당신은 몸은 사무실에 있지만 정신은 이미 저녁 메뉴, 침대, 주말 여행까지 다녀왔습니다. 마지막 한 시간은 현실보다 상상력이 더 강해지는 시간이며, 그래서 더 버겁기도 더 웃기기도 합니다. 존버의 낭만파입니다.', img: 'https://images.unsplash.com/photo-1499750310107-5fef28a66643?auto=format&fit=crop&w=800&q=80', color: '#14b8a6', tags: ['#영혼선퇴근', '#몽상파', '#퇴근카운트'] }
        }
    },
    {
        id: 'w4', category: '월급 루팡', title: '직장인 변명 센스 레벨 테스트', desc: '핑계는 곧 센스다. 들키지 않으면서도 너무 얄밉지 않은 당신의 회사형 변명 스킬을 측정합니다.', thumb: 'https://images.unsplash.com/photo-1516321497487-e288fb19713f?auto=format&fit=crop&w=800&q=80',
        questions: [
            { q: '답장이 늦어졌을 때 가장 그럴듯한 한마디는?', options: [{ text: '방금 확인했습니다, 바로 보겠습니다', scores: { logic: 2, empathy: 1 } }, { text: '회의가 길어져서 이제 봤어요', scores: { empathy: 2, logic: 1 } }, { text: '자료 정리하다 타이밍을 놓쳤습니다', scores: { creativity: 2, logic: 1 } }, { text: '지금 바로 처리 가능하게 맞춰보겠습니다', scores: { energy: 2, empathy: 1 } }] },
            { q: '지각 4분 전, 당신의 머릿속은?', options: [{ text: '교통 이슈 정리 중', scores: { logic: 2, creativity: 1 } }, { text: '죄송함을 얼마나 담을지 계산 중', scores: { empathy: 2, logic: 1 } }, { text: '어차피 걸렸으니 자연스럽게 간다', scores: { energy: 2, creativity: 1 } }, { text: '오늘 운세 탓하고 싶다', scores: { creativity: 2, empathy: 1 } }] },
            { q: '자료가 아직 덜 됐을 때 당신의 전략은?', options: [{ text: '진행 중인 구조부터 먼저 공유', scores: { logic: 2, energy: 1 } }, { text: '퀄리티 보완 중이라고 말한다', scores: { empathy: 2, logic: 1 } }, { text: '추가 확인 포인트가 있어 조금 더 본다', scores: { creativity: 2, logic: 1 } }, { text: '중요 우선순위부터 먼저 끝냈다고 한다', scores: { energy: 2, empathy: 1 } }] },
            { q: '가장 중요한 변명 요소는?', options: [{ text: '앞뒤 맥락이 맞아야 한다', scores: { logic: 2, empathy: 1 } }, { text: '듣는 사람이 기분 안 나빠야 한다', scores: { empathy: 2, creativity: 1 } }, { text: '조금은 참신해야 기억에 남는다', scores: { creativity: 2, energy: 1 } }, { text: '결국 빠르게 수습하면 된다', scores: { energy: 2, logic: 1 } }] },
            { q: '상사가 추가 설명을 요구하면?', options: [{ text: '세부 상황을 차분히 덧붙인다', scores: { logic: 2, empathy: 1 } }, { text: '먼저 죄송하다고 톤을 낮춘다', scores: { empathy: 2, logic: 1 } }, { text: '핵심만 간단히 정리해서 넘긴다', scores: { energy: 2, logic: 1 } }, { text: '상황을 조금 더 드라마틱하게 만든다', scores: { creativity: 2, empathy: 1 } }] },
            { q: '들키지 않는 변명의 조건은?', options: [{ text: '내 평소 이미지와 맞아야 한다', scores: { empathy: 2, logic: 1 } }, { text: '근거가 두세 개는 있어야 한다', scores: { logic: 2, creativity: 1 } }, { text: '말보다 태도가 자연스러워야 한다', scores: { energy: 2, empathy: 1 } }, { text: '살짝 웃픈 디테일이 필요하다', scores: { creativity: 2, empathy: 1 } }] },
            { q: '당신의 회사형 한 줄 평은?', options: [{ text: '최대한 깔끔하게 설명하는 사람', scores: { logic: 2, empathy: 1 } }, { text: '상대 기분까지 챙기며 수습하는 사람', scores: { empathy: 2, logic: 1 } }, { text: '묘하게 웃기게 넘어가는 사람', scores: { creativity: 2, energy: 1 } }, { text: '일단 돌파하고 본다', scores: { energy: 2, creativity: 1 } }] }
        ],
        results: {
            energy: { title: '돌파형 현장 수습러', desc: '당신은 완벽한 사전 설계보다, 상황이 터졌을 때 빠르게 수습하는 데 강합니다. 말도 행동도 빠르고, 어쨌든 흐름을 끊지 않는 쪽으로 움직입니다. 다소 투박해 보여도 실전에서 이상하게 살아남는 타입입니다.', img: 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=800&q=80', color: '#0f766e', tags: ['#현장수습', '#돌파형', '#일단살고보자'] },
            logic: { title: '근거 중심 변명 설계자', desc: '당신은 핑계조차 구조적으로 만듭니다. 타임라인, 이유, 후속 조치까지 앞뒤를 맞춰 설명해 듣는 사람도 쉽게 반박하기 어렵습니다. 솔직히 말하면 변명이라기보다 작은 프로젝트 관리에 가깝습니다.', img: 'https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&w=800&q=80', color: '#115e59', tags: ['#설계형', '#근거중심', '#반박불가'] },
