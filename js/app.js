...
const TESTS = [
    ...
    },
    {
        ...
        questions: [
            ...
            { q: '오늘 아침 눈을 떴을 때 가장 먼저 든 생각은?', options: [{ text: '오늘은 뭔가 좋은 일이 생길 것 같아', type: 'A' }, { text: '조금 피곤하지만 차분하게 시작해보자', type: 'B' }] },
    ...
    },
    {
        ...
        results: {
            A: { title: '사람이 따르는 인복 대마왕', desc: '당신 주변에는 항상 좋은 사람들이 넘쳐납니다. 당신의 밝은 에너지와 베푸는 마음이 귀인을 끌어당깁니다. 힘들 때마다 손을 내밀어 줄 조력자들이 평생 함께할 운명입니다.', img: unsplash('1511632765486-a01980e01a18') },
