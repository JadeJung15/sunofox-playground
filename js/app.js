import { initAuth, updateUI, UserState, addPoints as authAddPoints, authReady } from './auth.js?v=8.2.0';
import { copyLink } from './share.js?v=8.2.0';
import { renderBoard } from './board.js?v=8.2.0';
import { renderRanking } from './ranking.js?v=8.2.0';
...
import { renderHome, renderCategorySelection, fetchAllLikes, testLikesData } from './pages/home.js?v=8.2.0';
import { trackVisit, renderVisitorStats } from './services/siteStats.js?v=8.2.0';
import { renderProfile } from './pages/profile.js?v=8.2.0';
import { renderAdmin } from './pages/admin.js?v=8.2.0';
