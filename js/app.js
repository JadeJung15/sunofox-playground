...
function renderTerms() {
    app.innerHTML = `
        <div class="card legal-page fade-in">
            ...
            <div class="legal-content" style="line-height: 1.8; font-size: 0.95rem; color: var(--text-main);">
                <p>본 이용약관(이하 '약관')은 SevenCheck Studio(이하 '회사')가 제공하는 서비스 이용과 관련하여 회사와 회원 사이의 권리, 의무 및 책임사항을 규정합니다.</p>

                <h4 style="margin-top: 1.5rem;">1. 서비스의 제공 및 변경</h4>
                <p>회사는 다음과 같은 서비스를 제공합니다:<br>
                   - 심리 테스트 및 성향 분석 서비스<br>
                   - 포인트(P) 획득 및 아이템 수집 시스템 (Seven Arcade)<br>
                   - 이용자 간 커뮤니티 서비스</p>
                <p>회사는 기술적 사양의 변경이나 서비스의 운영 정책에 따라 서비스의 내용을 변경할 수 있으며, 이 경우 웹사이트를 통해 공지합니다.</p>

                <h4 style="margin-top: 1.5rem;">2. 계정 및 보안</h4>
                <p>회원은 구글(Google) 소셜 로그인을 통해 서비스를 이용할 수 있습니다. 회원은 자신의 계정 정보를 안전하게 관리해야 하며, 제3자에 의한 도용으로 발생하는 피해에 대한 책임은 회원에게 있습니다.</p>

                <h4 style="margin-top: 1.5rem;">3. 포인트 및 디지털 자산 (Arcade System)</h4>
                <p>- 서비스 내에서 획득한 포인트(P)와 아이템은 가상의 자산이며, 어떠한 경우에도 현금으로 환전되거나 외부로 인출될 수 없습니다.<br>
                   - 시스템 오류나 부정한 방법으로 획득한 포인트 및 아이템은 운영자에 의해 회수되거나 초기화될 수 있습니다.<br>
                   - 회사는 게임 밸런스 조정을 위해 아이템의 가치나 획득 확률을 사전 고지 후 변경할 수 있습니다.</p>

                <h4 style="margin-top: 1.5rem;">4. 사용자 준수 사항</h4>
                <p>이용자는 다음 행위를 해서는 안 됩니다:<br>
                   - 타인의 정보를 도용하거나 허위 사실을 유포하는 행위<br>
                   - 서비스의 안정적 운영을 방해하거나 시스템을 공격하는 행위 (매크로, 봇 사용 등)<br>
                   - 커뮤니티 내에서 욕설, 비방, 음란물 게시 등 타인에게 불쾌감을 주는 행위<br>
                   - 회사의 사전 승낙 없이 서비스를 이용한 영리 활동</p>

                <h4 style="margin-top: 1.5rem;">5. 책임의 한계 및 면책</h4>
                <p>- <b>심리 테스트 결과의 성격:</b> 본 서비스에서 제공하는 모든 분석 결과는 통계적 경향성과 재미를 위한 것이며, 의학적 진단이나 법적 근거로 사용될 수 없습니다.<br>
                   - 회사는 천재지변, 서버 점검, 통신 장애 등 불가항력적인 사유로 인해 발생하는 서비스 중단에 대해 책임을 지지 않습니다.</p>

                <h4 style="margin-top: 1.5rem;">6. 서비스 이용 제한 및 해지</h4>
                <p>회원이 본 약관을 위반하는 경우, 회사는 경고, 이용 정지, 계정 삭제 등의 조치를 취할 수 있습니다. 회원은 언제든지 설정 메뉴를 통해 서비스 이용 해지(탈퇴)를 요청할 수 있습니다.</p>

                <h4 style="margin-top: 1.5rem;">7. 관련 법령의 준수</h4>
                <p>본 약관에 명시되지 않은 사항은 대한민국 법령 및 일반적인 상관례에 따릅니다.</p>

                <p style="margin-top: 2rem; font-size: 0.85rem; color: var(--text-sub);">최종 수정일: 2026년 2월 25일</p>
            </div>
        </div>`;
}
