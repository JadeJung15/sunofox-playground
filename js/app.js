...
const TESTS = [
    ...
    {
        id: 'p4', category: '성격', title: '스트레스 방어기제 테스트', desc: '힘든 상황이 닥쳤을 때 당신의 마음이 어떻게 스스로를 보호하는지 알아봅니다.', thumb: unsplash('1516302752625-fbcad1505f9f'),
        questions: [
    ...
    {
        id: 'p20', category: '성격', title: '나의 자아 성찰 리포트', desc: '당신이 스스로를 얼마나 잘 알고 있는지, 내면의 성숙도를 7단계로 분석합니다.', thumb: unsplash('1528716321680-8a520d21decb'),
        questions: [
...
for (let i = 21; i <= 50; i++) {
    const categories = ['얼굴', '사주', '재미'];
    const cat = categories[Math.floor((i-21) / 10)] || '재미';
    ...
    TESTS.push({
        ...
        results: {
            ...
            B: { title: `${theme} 가이드`, desc: `당신의 ${theme} 분야에서 유연하고 포용적인 분위기를 지닌 타입입니다.`, img: unsplash(`15${i}111222333`) }
        }
    });
}
