import { db, storage } from './firebase-init.js?v=8.2.0';
import { UserState, usePoints, addPoints, fetchUserProfile, updateProfileCache, fetchUserRank } from './auth.js?v=8.2.0';
