import { initAuth, updateUI, UserState, addPoints as authAddPoints, authReady, postEconomyAction } from './auth.js?v=8.5.1';
import { copyLink } from './share.js?v=8.5.1';
import { renderBoard } from './board.js?v=8.5.1';
import { renderRanking } from './ranking.js?v=8.5.1';
import { db } from './firebase-init.js?v=8.5.1';
import { doc, getDoc } from "https://www.gstatic.com/firebasejs/12.9.0/firebase-firestore.js";

import { renderHome, renderCategorySelection, fetchAllLikes, testLikesData } from './pages/home.js?v=8.5.1';
import { trackVisit, renderVisitorStats } from './services/siteStats.js?v=8.5.1';
import { renderProfile } from './pages/profile.js?v=8.5.1';
import { renderAdmin } from './pages/admin.js?v=8.5.1';
import { renderArcade } from './pages/arcade-page.js?v=8.5.1';
import { renderTestExecution, renderResult } from './pages/tests.js?v=8.5.1';
import { renderSalaryGame } from './pages/salary.js?v=8.5.1';
import { renderAbout, renderPrivacy, renderTerms, renderContact, renderGuide, renderEncyclopedia } from './pages/info.js?v=8.5.1';
import { renderDailyList, renderDailyDetail } from './pages/daily.js?v=8.5.1';
