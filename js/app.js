                        ...
                        <div class="card user-admin-card" style="padding: 1.25rem; margin-bottom:0; display:flex; flex-direction:column; gap:1rem; border: 1px solid var(--border-color);">
                            <div style="display:flex; justify-content:space-between; align-items:flex-start;">
                                <div style="overflow:hidden;">
                                    ...
                                    <p style="font-size:0.75rem; color:var(--accent-color); font-weight:600; margin-bottom:0.4rem;">${data.originalName ? `(${data.originalName})` : '<span style="color:var(--text-sub);">(이름 미기록)</span>'}</p>
