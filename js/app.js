import { initAuth, updateUI, UserState, addPoints as authAddPoints, authReady } from './auth.js?v=7.0.0';
import { copyLink } from './share.js?v=7.0.0';
import { renderBoard } from './board.js?v=7.0.0';
import { renderRanking } from './ranking.js?v=7.0.0';
...
import { renderHome, renderCategorySelection, fetchAllLikes, testLikesData } from './pages/home.js?v=7.0.0';
import { trackVisit, renderVisitorStats } from './services/siteStats.js?v=7.0.0';
import { renderProfile } from './pages/profile.js?v=7.0.0';
import { renderAdmin } from './pages/admin.js?v=7.0.0';
import { renderArcade } from './pages/arcade-page.js?v=7.0.0';
import { renderTestExecution, renderResult } from './pages/tests.js?v=7.0.0';
import { renderAbout, renderPrivacy, renderTerms, renderContact, renderGuide, renderEncyclopedia } from './pages/info.js?v=7.0.0';
