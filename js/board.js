import { db, storage } from './firebase-init.js?v=7.0.0';
import { UserState, usePoints, addPoints, fetchUserProfile, updateProfileCache, fetchUserRank } from './auth.js?v=7.0.0';
